...
REG ADD HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.plax\OpenWithList /v "a" /t REG_SZ /d "C:/Program Files/Notepad++/Notepad++.exe"
REG ADD HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.plax\OpenWithList /v "b" /t REG_SZ /d "C:/Program Files/Sublime Text/sublime_text.exe"
REG ADD HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.plax\OpenWithList /v "c" /t REG_SZ /d "code.exe"
